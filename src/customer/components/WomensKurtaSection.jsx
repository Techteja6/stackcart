...
import womensCartItems from '../data/womensCartItems';

const WomensKurtaSection = ({ addToCart }) => {
  ...
  return (
    <section className="bg-white py-12 px-4 md:px-6 w-full">
      <h2 className="text-3xl font-bold text-center mb-6">Women's Kurtas</h2>
      <p className="text-center text-gray-600 mb-10">
        Discover elegant and trendy kurtas for every occasion.
      </p>
          ...
          {womensCartItems.map((item) => (
            ...
            >
              ...
              <div className="p-4 text-center">
                ...
                <p className="mt-2 text-pink-600 font-bold">₹{item.price}</p>
                <button
...
export default WomensKurtaSection;