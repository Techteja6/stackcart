...
const ShoesSection = ({ addToCart }) => {
  ...
  return (
    <section className="bg-white py-12 px-4 md:px-6 w-full">
      <h2 className="text-3xl font-bold text-center mb-6">Shoes Collection</h2>
      <p className="text-center text-gray-600 mb-10">
        Step into style with our latest footwear picks.
      </p>
          ...
          {shoesItems.map((item) => (
            ...
            >
              <img
                src={item.image}
                alt={item.name}
                className="w-[220px] h-[220px] object-contain p-2 rounded-lg bg-white"
              />
